...
typedef struct CThostFtdcReqUserLoginSMField CThostFtdcReqUserLoginSMField;
...
typedef struct CThostFtdcInvestorTradingRightField CThostFtdcInvestorTradingRightField;
typedef struct CThostFtdcMortgageParamField CThostFtdcMortgageParamField;
typedef struct CThostFtdcWithDrawParamField CThostFtdcWithDrawParamField;
typedef struct CThostFtdcThostUserFunctionField CThostFtdcThostUserFunctionField;
typedef struct CThostFtdcQryThostUserFunctionField CThostFtdcQryThostUserFunctionField;
typedef struct CThostFtdcSPBMAddOnInterParameterField CThostFtdcSPBMAddOnInterParameterField;
typedef struct CThostFtdcQrySPBMAddOnInterParameterField CThostFtdcQrySPBMAddOnInterParameterField;
typedef struct CThostFtdcQryInvestorCommoditySPMMMarginField CThostFtdcQryInvestorCommoditySPMMMarginField;
typedef struct CThostFtdcQryInvestorCommodityGroupSPMMMarginField CThostFtdcQryInvestorCommodityGroupSPMMMarginField;
typedef struct CThostFtdcQrySPMMInstParamField CThostFtdcQrySPMMInstParamField;
typedef struct CThostFtdcQrySPMMProductParamField CThostFtdcQrySPMMProductParamField;
typedef struct CThostFtdcInvestorCommoditySPMMMarginField CThostFtdcInvestorCommoditySPMMMarginField;
typedef struct CThostFtdcInvestorCommodityGroupSPMMMarginField CThostFtdcInvestorCommodityGroupSPMMMarginField;
typedef struct CThostFtdcSPMMInstParamField CThostFtdcSPMMInstParamField;
typedef struct CThostFtdcSPMMProductParamField CThostFtdcSPMMProductParamField;
typedef struct CThostFtdcQryTraderAssignField CThostFtdcQryTraderAssignField;
typedef struct CThostFtdcTraderAssignField CThostFtdcTraderAssignField;
typedef struct CThostFtdcInvestorInfoCntSettingField CThostFtdcInvestorInfoCntSettingField;
typedef struct CThostFtdcRCAMSCombProductInfoField CThostFtdcRCAMSCombProductInfoField;
typedef struct CThostFtdcRCAMSInstrParameterField CThostFtdcRCAMSInstrParameterField;
typedef struct CThostFtdcRCAMSIntraParameterField CThostFtdcRCAMSIntraParameterField;
typedef struct CThostFtdcRCAMSInterParameterField CThostFtdcRCAMSInterParameterField;
typedef struct CThostFtdcRCAMSShortOptAdjustParamField CThostFtdcRCAMSShortOptAdjustParamField;
typedef struct CThostFtdcRCAMSInvestorCombPositionField CThostFtdcRCAMSInvestorCombPositionField;
typedef struct CThostFtdcInvestorProdRCAMSMarginField CThostFtdcInvestorProdRCAMSMarginField;
typedef struct CThostFtdcQryRCAMSCombProductInfoField CThostFtdcQryRCAMSCombProductInfoField;
typedef struct CThostFtdcQryRCAMSInstrParameterField CThostFtdcQryRCAMSInstrParameterField;
typedef struct CThostFtdcQryRCAMSIntraParameterField CThostFtdcQryRCAMSIntraParameterField;
typedef struct CThostFtdcQryRCAMSInterParameterField CThostFtdcQryRCAMSInterParameterField;
typedef struct CThostFtdcQryRCAMSShortOptAdjustParamField CThostFtdcQryRCAMSShortOptAdjustParamField;
typedef struct CThostFtdcQryRCAMSInvestorCombPositionField CThostFtdcQryRCAMSInvestorCombPositionField;
typedef struct CThostFtdcQryInvestorProdRCAMSMarginField CThostFtdcQryInvestorProdRCAMSMarginField;
typedef struct CThostFtdcRULEInstrParameterField CThostFtdcRULEInstrParameterField;
typedef struct CThostFtdcRULEIntraParameterField CThostFtdcRULEIntraParameterField;
typedef struct CThostFtdcRULEInterParameterField CThostFtdcRULEInterParameterField;
typedef struct CThostFtdcQryRULEInstrParameterField CThostFtdcQryRULEInstrParameterField;
typedef struct CThostFtdcQryRULEIntraParameterField CThostFtdcQryRULEIntraParameterField;
typedef struct CThostFtdcQryRULEInterParameterField CThostFtdcQryRULEInterParameterField;
typedef struct CThostFtdcInvestorProdRULEMarginField CThostFtdcInvestorProdRULEMarginField;
typedef struct CThostFtdcQryInvestorProdRULEMarginField CThostFtdcQryInvestorProdRULEMarginField;
typedef struct CThostFtdcSyncDeltaSPBMPortfDefinitionField CThostFtdcSyncDeltaSPBMPortfDefinitionField;
typedef struct CThostFtdcSyncDeltaSPBMInvstPortfDefField CThostFtdcSyncDeltaSPBMInvstPortfDefField;
typedef struct CThostFtdcSyncDeltaSPBMFutureParameterField CThostFtdcSyncDeltaSPBMFutureParameterField;
typedef struct CThostFtdcSyncDeltaSPBMOptionParameterField CThostFtdcSyncDeltaSPBMOptionParameterField;
typedef struct CThostFtdcSyncDeltaSPBMIntraParameterField CThostFtdcSyncDeltaSPBMIntraParameterField;
typedef struct CThostFtdcSyncDeltaSPBMInterParameterField CThostFtdcSyncDeltaSPBMInterParameterField;
typedef struct CThostFtdcSyncDeltaSPBMAddOnInterParamField CThostFtdcSyncDeltaSPBMAddOnInterParamField;
typedef struct CThostFtdcSyncDeltaSPMMInstParamField CThostFtdcSyncDeltaSPMMInstParamField;
typedef struct CThostFtdcSyncDeltaSPMMProductParamField CThostFtdcSyncDeltaSPMMProductParamField;
typedef struct CThostFtdcSyncDeltaInvestorSPMMModelField CThostFtdcSyncDeltaInvestorSPMMModelField;
typedef struct CThostFtdcSyncDeltaSPMMModelParamField CThostFtdcSyncDeltaSPMMModelParamField;
typedef struct CThostFtdcSyncDeltaRCAMSCombProdInfoField CThostFtdcSyncDeltaRCAMSCombProdInfoField;
typedef struct CThostFtdcSyncDeltaRCAMSInstrParameterField CThostFtdcSyncDeltaRCAMSInstrParameterField;
typedef struct CThostFtdcSyncDeltaRCAMSIntraParameterField CThostFtdcSyncDeltaRCAMSIntraParameterField;
typedef struct CThostFtdcSyncDeltaRCAMSInterParameterField CThostFtdcSyncDeltaRCAMSInterParameterField;
typedef struct CThostFtdcSyncDeltaRCAMSSOptAdjParamField CThostFtdcSyncDeltaRCAMSSOptAdjParamField;
typedef struct CThostFtdcSyncDeltaRCAMSCombRuleDtlField CThostFtdcSyncDeltaRCAMSCombRuleDtlField;
typedef struct CThostFtdcSyncDeltaRCAMSInvstCombPosField CThostFtdcSyncDeltaRCAMSInvstCombPosField;
typedef struct CThostFtdcSyncDeltaRULEInstrParameterField CThostFtdcSyncDeltaRULEInstrParameterField;
typedef struct CThostFtdcSyncDeltaRULEIntraParameterField CThostFtdcSyncDeltaRULEIntraParameterField;
typedef struct CThostFtdcSyncDeltaRULEInterParameterField CThostFtdcSyncDeltaRULEInterParameterField;
typedef struct CThostFtdcIpAddrParamField CThostFtdcIpAddrParamField;
typedef struct CThostFtdcQryIpAddrParamField CThostFtdcQryIpAddrParamField;
typedef struct CThostFtdcTGIpAddrParamField CThostFtdcTGIpAddrParamField;
typedef struct CThostFtdcQryTGIpAddrParamField CThostFtdcQryTGIpAddrParamField;
typedef struct CThostFtdcTGSessionQryStatusField CThostFtdcTGSessionQryStatusField;
typedef struct CThostFtdcLocalAddrConfigField CThostFtdcLocalAddrConfigField;
typedef struct CThostFtdcQryLocalAddrConfigField CThostFtdcQryLocalAddrConfigField;
typedef struct CThostFtdcReqQueryBankAccountBySecField CThostFtdcReqQueryBankAccountBySecField;
typedef struct CThostFtdcRspQueryBankAccountBySecField CThostFtdcRspQueryBankAccountBySecField;
typedef struct CThostFtdcReqTransferBySecField CThostFtdcReqTransferBySecField;
typedef struct CThostFtdcRspTransferBySecField CThostFtdcRspTransferBySecField;
typedef struct CThostFtdcNotifyQueryFutureAccountBySecField CThostFtdcNotifyQueryFutureAccountBySecField;
typedef struct CThostFtdcExitEmergencyField CThostFtdcExitEmergencyField;
typedef struct CThostFtdcInvestorPortfMarginModelField CThostFtdcInvestorPortfMarginModelField;
typedef struct CThostFtdcInvestorPortfSettingField CThostFtdcInvestorPortfSettingField;
typedef struct CThostFtdcQryInvestorPortfSettingField CThostFtdcQryInvestorPortfSettingField;
typedef struct CThostFtdcUserPasswordUpdateFromSecField CThostFtdcUserPasswordUpdateFromSecField;
typedef struct CThostFtdcSettlementInfoConfirmFromSecField CThostFtdcSettlementInfoConfirmFromSecField;
typedef struct CThostFtdcTradingAccountPasswordUpdateFromSecField CThostFtdcTradingAccountPasswordUpdateFromSecField;
typedef struct CThostFtdcRiskForbiddenRightField CThostFtdcRiskForbiddenRightField;
typedef struct CThostFtdcInvestorInfoCommRecField CThostFtdcInvestorInfoCommRecField;
typedef struct CThostFtdcQryInvestorInfoCommRecField CThostFtdcQryInvestorInfoCommRecField;
typedef struct CThostFtdcCombLegField CThostFtdcCombLegField;
typedef struct CThostFtdcQryCombLegField CThostFtdcQryCombLegField;
typedef struct CThostFtdcFrontInfoField CThostFtdcFrontInfoField;
